...
MODEL		= CalebsLaunchControl
WRAPPER		= CalebsLaunchControl_wrap
CLASS		= PowerTrainXWD
DESCRIPTION	= "My first launch control "
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
SRCS		= CalebsLaunchControl_data.c
...
INC_CFLAGS	+= -I$(subst \,/,"C:\CM_Projects\LaunchControl\src_cm4sl\CalebsLaunchControl_CarMaker_rtw")
