...
#ifndef RTW_HEADER_CalebsLaunchControl_types_h_
#define RTW_HEADER_CalebsLaunchControl_types_h_
#include "rtwtypes.h"
...
typedef struct P_IfActionSubsystem_CalebsLaunchControl_T_
  P_IfActionSubsystem_CalebsLaunchControl_T;

/* Parameters (default storage) */
typedef struct P_CalebsLaunchControl_T_ P_CalebsLaunchControl_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_CalebsLaunchControl_T RT_MODEL_CalebsLaunchControl_T;

#endif                             /* RTW_HEADER_CalebsLaunchControl_types_h_ */
