...
extern const char ExperimentalPowertrain_LibIdent[];
const char ExperimentalPowertrain_LibIdent[] = "(@@)" QUOTE(MODEL) " " ARCH " 1.0 " BUILDDATE;
...
static void
DoOneStep (rtModel_ExperimentalPowertrain *rtm)
{
...
static void
ExperimentalPowertrain_DeclQuants (void *MP)
{
    rtModel_ExperimentalPowertrain *rtm = (rtModel_ExperimentalPowertrain *)MP;
    int i;
	...
	/* Remember body frames defined in this model for later registration. */
        MdlBdyFrame_Add(ExperimentalPowertrain_BdyFrameDefines);

	/* Define dict entries for non-dynamically allocated variables. */
	if ((i = MatSupp_DeclQuants(ExperimentalPowertrain_DictDefines)) >= 0) {
	    LogErrF(EC_Init, "Model '%s': Error defining quantity '%s'\n",
		    Modelname, ExperimentalPowertrain_DictDefines[i].Name);
	}
...
/*
 * ExperimentalPowertrain_SetParams() will be invoked indirectly by the generated
 * model C code each time ExperimentalPowertrain_New() is called.
 */
void
ExperimentalPowertrain_SetParams (rtModel_ExperimentalPowertrain *rtm, struct tMatSuppTunables *tuns,
		   struct tInfos *Inf)
{
    /*Log("%s_SetParams()\n", Modelname);*/
...
assignCfgIF (struct tPowerTrainXWD_CfgIF *CfgIF, void *MP)
{
    ...
    ExternalInputs_ExperimentalPowertrain  *in  = (ExternalInputs_ExperimentalPowertrain *) rtmGetU(rtm);
...
static void *
ExperimentalPowertrain_New (struct tInfos *Inf, struct tPowerTrainXWD_CfgIF *CfgIF, const char *KindKey)
{
    rtModel_ExperimentalPowertrain *rtm;
    ...
    MatSupp_ResetQuants(ExperimentalPowertrain_DictDefines);
...
static void
ExperimentalPowertrain_Delete (void *MP)
{
    rtModel_ExperimentalPowertrain *rtm = (rtModel_ExperimentalPowertrain *)MP;
...
static int
ExperimentalPowertrain_Calc (void *MP, struct tPowerTrainXWD_IF  *IF, double dt)
{
    rtModel_ExperimentalPowertrain *rtm = (rtModel_ExperimentalPowertrain *)MP;
    int osCount=0;
    ExternalInputs_ExperimentalPowertrain  *in  = (ExternalInputs_ExperimentalPowertrain *) rtmGetU(rtm);
    ExternalOutputs_ExperimentalPowertrain *out = (ExternalOutputs_ExperimentalPowertrain *)rtmGetY(rtm);
...
int
ExperimentalPowertrain_Register (void)
{
    tModelClassDescr m;
    ...
    m.PowerTrainXWD.DeclQuants		= ExperimentalPowertrain_DeclQuants;
    m.PowerTrainXWD.New			= ExperimentalPowertrain_New;
    m.PowerTrainXWD.Calc		= ExperimentalPowertrain_Calc;
    m.PowerTrainXWD.Delete		= ExperimentalPowertrain_Delete;
