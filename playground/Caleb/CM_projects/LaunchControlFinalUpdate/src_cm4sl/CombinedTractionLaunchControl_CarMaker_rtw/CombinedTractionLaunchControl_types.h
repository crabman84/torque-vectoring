/*
 * CombinedTractionLaunchControl_types.h
 *
...
#ifndef RTW_HEADER_CombinedTractionLaunchControl_types_h_
#define RTW_HEADER_CombinedTractionLaunchControl_types_h_
#include "rtwtypes.h"
...
typedef struct P_IfActionSubsystem_CombinedTractionLaunchControl_T_
  P_IfActionSubsystem_CombinedTractionLaunchControl_T;

/* Parameters for system: '<S23>/If Action Subsystem' */
typedef struct P_IfActionSubsystem_CombinedTractionLaunchControl_p_T_
  P_IfActionSubsystem_CombinedTractionLaunchControl_p_T;

/* Parameters for system: '<S23>/If Action Subsystem1' */
typedef struct P_IfActionSubsystem1_CombinedTractionLaunchControl_T_
  P_IfActionSubsystem1_CombinedTractionLaunchControl_T;

/* Parameters (default storage) */
typedef struct P_CombinedTractionLaunchControl_T_
  P_CombinedTractionLaunchControl_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_CombinedTractionLaunchControl_T
  RT_MODEL_CombinedTractionLaunchControl_T;

#endif                   /* RTW_HEADER_CombinedTractionLaunchControl_types_h_ */
