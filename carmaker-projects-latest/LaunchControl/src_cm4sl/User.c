...
#include "CalebsLaunchControl_CarMaker_rtw/CalebsLaunchControl_wrap.h"
#include "CombinedTractionLaunchControl_CarMaker_rtw/CombinedTractionLaunchControl_wrap.h"
#include "FinalSystem_CarMaker_rtw/FinalSystem_wrap.h"
#include "SAE_Powertrain_CarMaker_rtw/SAE_Powertrain_wrap.h"
#include "ExperimentalPowertrain_CarMaker_rtw/ExperimentalPowertrain_wrap.h"
#include "RuleBasedTractionControl_CarMaker_rtw/RuleBasedTractionControl_wrap.h"
/* @@PLUGIN-END@@ */
...
User_Register (void)
{
    ...
    CalebsLaunchControl_Register();
    CombinedTractionLaunchControl_Register();
    FinalSystem_Register();
    SAE_Powertrain_Register();
    ExperimentalPowertrain_Register();
    RuleBasedTractionControl_Register();
    /* @@PLUGIN-END@@ */
