/*
 * RuleBasedTractionControl_types.h
 *
...
#ifndef RTW_HEADER_RuleBasedTractionControl_types_h_
#define RTW_HEADER_RuleBasedTractionControl_types_h_
#include "rtwtypes.h"
...
typedef struct P_IfActionSubsystem_RuleBasedTractionControl_T_
  P_IfActionSubsystem_RuleBasedTractionControl_T;

/* Parameters for system: '<S19>/If Action Subsystem' */
typedef struct P_IfActionSubsystem_RuleBasedTractionControl_j_T_
  P_IfActionSubsystem_RuleBasedTractionControl_j_T;

/* Parameters for system: '<S19>/If Action Subsystem3' */
typedef struct P_IfActionSubsystem3_RuleBasedTractionControl_T_
  P_IfActionSubsystem3_RuleBasedTractionControl_T;

/* Parameters (default storage) */
typedef struct P_RuleBasedTractionControl_T_ P_RuleBasedTractionControl_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_RuleBasedTractionControl_T
  RT_MODEL_RuleBasedTractionControl_T;

#endif                        /* RTW_HEADER_RuleBasedTractionControl_types_h_ */
