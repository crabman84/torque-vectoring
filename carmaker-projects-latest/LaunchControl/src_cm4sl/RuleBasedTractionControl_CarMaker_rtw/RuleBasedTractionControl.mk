...
MODEL		= RuleBasedTractionControl
WRAPPER		= RuleBasedTractionControl_wrap
CLASS		= PowerTrainXWD
DESCRIPTION	= "Rule Based TC"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
SRCS		= RuleBasedTractionControl_data.c
...
INC_CFLAGS	+= -I$(subst \,/,"C:\CM_Projects\LaunchControl\src_cm4sl\RuleBasedTractionControl_CarMaker_rtw")
