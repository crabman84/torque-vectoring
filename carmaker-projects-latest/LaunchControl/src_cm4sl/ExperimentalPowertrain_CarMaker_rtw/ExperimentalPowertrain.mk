...
MODEL		= ExperimentalPowertrain
WRAPPER		= ExperimentalPowertrain_wrap
CLASS		= PowerTrainXWD
DESCRIPTION	= "Experimental Powertrain"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
SRCS		= ExperimentalPowertrain_data.c
...
INC_CFLAGS	+= -I$(subst \,/,"C:\CM_Projects\LaunchControl\src_cm4sl\ExperimentalPowertrain_CarMaker_rtw")
