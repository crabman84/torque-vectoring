/*
 * ExperimentalPowertrain_types.h
 *
...
#ifndef RTW_HEADER_ExperimentalPowertrain_types_h_
#define RTW_HEADER_ExperimentalPowertrain_types_h_
#include "rtwtypes.h"
...
typedef struct P_IfActionSubsystem_ExperimentalPowertrain_T_
  P_IfActionSubsystem_ExperimentalPowertrain_T;

/* Parameters (default storage) */
typedef struct P_ExperimentalPowertrain_T_ P_ExperimentalPowertrain_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_ExperimentalPowertrain_T
  RT_MODEL_ExperimentalPowertrain_T;

#endif                          /* RTW_HEADER_ExperimentalPowertrain_types_h_ */
