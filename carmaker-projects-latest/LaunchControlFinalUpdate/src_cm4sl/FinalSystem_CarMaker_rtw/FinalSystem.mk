...
include C:/IPG/carmaker/win64-8.1.1/include/MakeDefs.win64
...
MAKECMD         = "C:/IPG/carmaker/win64-8.1.1/bin/cmmake"
HOST            = ANY
BUILD           = yes
...
MODEL		= FinalSystem
WRAPPER		= FinalSystem_wrap
CLASS		= |>CM_MODELCLASS<|
DESCRIPTION	= "|>CM_DESCRIPTION<|"
MAINMODEL	= "|>CM_MAINMODEL<|"
PARAMID		= |>CM_PARAMID<|
SYMBOLS		= "|>CM_SYMBOLS<|"
...
OBJS	= $(MODEL).o $(patsubst rt_malloc_main.o,,$(SRCS:.c=.o))
ifeq ($(MODELREF_TARGET_TYPE), NONE)
  OBJS	+= $(WRAPPER).o
endif
...
CM_SRCDIR	= "$(subst \,/,|>CM_SRCDIR<|)"
CM_PROJHOOKUP	= |>CM_PROJHOOKUP<|
CM_PROJMAKE	= |>CM_PROJMAKE<|
...
INC_CFLAGS	+= -I$(subst \,/,"C:\CM_Projects\LaunchControl\src_cm4sl")
INC_CFLAGS	+= -I$(subst \,/,"C:\CM_Projects\LaunchControl\src_cm4sl\FinalSystem_CarMaker_rtw")
...
ifeq ($(filter linux linux64 win32 win64 xeno xeno64 lvrt ds1006 dsrt, $(ARCH)), )
	$Q rm -f $@
	$(QECHO) " AR qs    $@"
	$Q $(AR) qs $@ $(OBJS)
else
