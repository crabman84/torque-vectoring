...
#ifndef RTW_HEADER_FinalSystem_types_h_
#define RTW_HEADER_FinalSystem_types_h_
#include "rtwtypes.h"
...
typedef struct P_IfActionSubsystem_FinalSystem_T_
  P_IfActionSubsystem_FinalSystem_T;

/* Parameters for system: '<S21>/If Action Subsystem' */
typedef struct P_IfActionSubsystem_FinalSystem_c_T_
  P_IfActionSubsystem_FinalSystem_c_T;

/* Parameters for system: '<S22>/If Action Subsystem1' */
typedef struct P_IfActionSubsystem1_FinalSystem_T_
  P_IfActionSubsystem1_FinalSystem_T;

/* Parameters (default storage) */
typedef struct P_FinalSystem_T_ P_FinalSystem_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_FinalSystem_T RT_MODEL_FinalSystem_T;

#endif                                 /* RTW_HEADER_FinalSystem_types_h_ */
